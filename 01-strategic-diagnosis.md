...
**And underneath all of it, support is already failing the math.** "Support tickets have grown five or 10x and we can only grow the support team two x." This is the canary. Support is usually the first place where "hire great people and trust them" runs into a queue that doesn't care how great anyone is — the queue just keeps growing regardless. If any of this is straining first, it's probably here, and probably already visible to whoever's managing that team.
